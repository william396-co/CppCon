...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&results_per_page_) -
    reinterpret_cast<char*>(&page_number_)) + sizeof(results_per_page_));
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          results_per_page_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SearchRequest::_InternalSerialize(
  ...
  if (this->_internal_results_per_page() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(3, this->_internal_results_per_page(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:SearchRequest)
  ...
  // int32 results_per_page = 3;
  if (this->_internal_results_per_page() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_results_per_page());
  }
...
void SearchRequest::InternalSwap(SearchRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SearchRequest, results_per_page_)
      + sizeof(SearchRequest::results_per_page_)
      - PROTOBUF_FIELD_OFFSET(SearchRequest, page_number_)>(
